...
void StudentTest(){
	Matrix m21(3,4,0);//initializes new normal array for testing
	m21.set(0,0,1);
	m21.set(0,1,2);
	m21.set(0,2,3);
	m21.set(0,3,4);
	...
	std::cout<<m22;
	Matrix* x;
	x = m22.quarter();//check for quarter then transpose
	std::cout<<m21;
	m21.transpose();
	std::cout<<m21;
...
void ExtraCreditTest(){
	Matrix m29(3,4,0);//initlaizess normal array
	m29.set(0,0,1);
	m29.set(0,1,2);
	m29.set(0,2,3);
	m29.set(0,3,4);
	...
	std::cout<<m29;
	m29.resize(10,10,0);//resize to 10X10
	std::cout<<m29;
	m29.resize(10,0,0);//resize to 0
	std::cout<<m29;
	m29.transpose();//transposes null matrix
	std::cout<<m29;
